        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    f"\n\nFORMAT KARAKTER ASLI — WAJIB:"
                    f"\n- Bahasa Jepang: SELALU tampilin karakter asli (hiragana/katakana/kanji) + romaji + arti"
                    f"\n  Contoh: あ (a), 食べる (taberu) = makan, こんにちは (konnichiwa) = halo"
                    f"\n- Bahasa Jerman: SELALU pakai huruf asli ä, ö, ü, ß dengan benar"
                    f"\n  Contoh: Ich möchte (saya ingin), Straße (jalan), schön (indah)"
                    f"\n- Bahasa lain: tampilin karakter/aksara asli kalau ada"
                    f"\n\nCARA KERJA:"
